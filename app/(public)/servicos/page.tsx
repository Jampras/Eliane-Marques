      ...
      <Container>
        <div className="mx-auto max-w-3xl text-center">
          ...
          <Text className="mx-auto mt-5 max-w-[640px] text-[14px] text-[color:var(--taupe)]">
            Acompanhamentos privados para mulheres que desejam alinhar presenca, narrativa e comportamento ao nivel de valor que ja carregam.
          </Text>
        </div>
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 xl:grid-cols-2">
          {services.map((service, index) => {
            ...
            return (
              <article
                key={service.id}
                className="fade-up relative border border-[color:var(--linho)] bg-[color:var(--aveia)] px-5 py-6 sm:px-6 sm:py-7 shadow-[2px_3px_12px_rgba(58,36,24,0.06)] lg:px-8 lg:py-9"
              ...
              >
                ...
                <div className="mt-7 flex flex-col gap-4 border-t border-[color:var(--linho)] pt-5 sm:flex-row sm:items-end sm:justify-between">
                  ...
                  <WhatsAppLink href={waUrl} className="inline-flex w-full sm:w-auto">
                    <span className="inline-flex w-full justify-center rounded-[1px] border border-[color:var(--linho)] px-5 py-3 sm:w-auto text-[9px] uppercase tracking-[0.18em] text-[color:var(--cacau)] transition-colors hover:border-[color:var(--argila)] hover:text-[color:var(--argila)]">
                      Agendar agora
                    </span>
                  </WhatsAppLink>
                </div>
