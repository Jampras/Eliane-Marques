      ...
      <section className="py-12 lg:py-16">
        <Container>
          <div className="mx-auto max-w-6xl animate-pulse space-y-10">
            ...
            <div className="mx-auto h-5 max-w-2xl bg-[color:rgba(221,208,188,0.7)]" />

            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
              {Array.from({ length: 6 }).map((_, index) => (
                <div
                  key={index}
                  className="border border-[color:var(--linho)] bg-[color:var(--manteiga)] p-6 shadow-[2px_3px_12px_rgba(58,36,24,0.06)]"
                >
                  <div className="mb-5 h-44 border border-[color:var(--linho)] bg-[color:var(--aveia)]" />
                  <div className="mb-4 h-4 w-24 bg-[color:rgba(184,132,90,0.18)]" />
                  <div className="mb-4 h-8 w-3/4 bg-[color:var(--aveia)]" />
                  <div className="mb-2 h-4 bg-[color:rgba(221,208,188,0.85)]" />
                  <div className="mb-8 h-4 w-5/6 bg-[color:rgba(221,208,188,0.7)]" />
