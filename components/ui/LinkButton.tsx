...
export const LinkButton: React.FC<LinkButtonProps> = ({
  ...
  const variants = {
    primary:
      'border border-[color:var(--cacau)] bg-[color:var(--cacau)] text-[color:var(--aveia)] shadow-[var(--theme-button-primary-shadow)] hover:border-[color:var(--espresso)] hover:bg-[color:var(--espresso)] hover:shadow-[var(--theme-button-primary-shadow-strong)]',
    outline:
    ...
    ghost: 'border border-transparent text-text-2 hover:bg-[color:var(--theme-button-ghost-hover)] hover:text-[color:var(--espresso)]',
  };
