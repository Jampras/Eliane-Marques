...
export function FinalCtaSection({
  ...
  return (
    <Section id="cta-final" variant="black" className="relative !py-8 sm:!py-10 lg:!py-12">
      <Container>
        <div className="mx-auto max-w-4xl border border-white/8 bg-[rgba(247,240,230,0.03)] px-6 py-8 shadow-[0_16px_42px_rgba(0,0,0,0.12)] sm:px-8 sm:py-9 lg:px-10 lg:py-10">
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1.2fr)_320px] lg:items-center">
            <div>
              <div className="fade-up" style={{ '--delay': '0s' } as CSSProperties}>
                <Badge className="border-white/12 bg-[rgba(247,240,230,0.05)] !text-[color:var(--mel)]">
                  Proximo passo
                </Badge>
              </div>
              <Heading
                className="fade-up mt-5 max-w-[12ch] text-[1.8rem] !text-[color:var(--aveia)] lg:text-[2.35rem]"
              ...
              <p
                className="fade-up mt-3 max-w-[40ch] text-[12px] leading-[1.85] text-white/68 lg:text-[13px]"
              ...
              <p
                className="fade-up mt-4 font-ornament text-[0.98rem] italic text-[color:var(--taupe)]"
            ...
            <div
              className="fade-up border border-white/10 bg-[rgba(247,240,230,0.04)] px-5 py-5"
              style={{ '--delay': '0.24s' } as CSSProperties}
            >
              <p className="text-[9px] uppercase tracking-[0.18em] text-[color:var(--mel)]">
                Conversa inicial
              </p>
              <div className="mt-4 space-y-3 text-[12px] leading-[1.75] text-white/68">
